...
gridSearch = do
    ...
    let hparCombs' :: [(HparComb, IO (EvalResult, IO ()))] = fmap (second (`finally` incProgress pb 1)) $ (!! length exprBlocks) $ getRules @device @0 cfg taskFnDataset hparCombs
